		...
		<div class="container">
			...
			<div class="row clearfix">
				...
				<div class="col-md-8 column">
					<form id="deleteComponentForm" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-md-3 control-label" for="comp">Component</label>
							<div class="col-md-9">
								<select name="compName" class="form-control" id="comp-select">
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-9">
								<button id="submitBttn" type="submit" class="btn"
									value="deleteComponent">Submit</button>
							</div>
						</div>
					</form>
				</div>
	...
	$(window)
			.load(
					function() {
						...
						$
								.ajax({
									url : "/healthCheck/getAllComponentList",
									type : "GET",
