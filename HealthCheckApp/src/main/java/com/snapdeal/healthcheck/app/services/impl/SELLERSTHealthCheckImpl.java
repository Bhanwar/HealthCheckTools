...
public class SELLERSTHealthCheckImpl implements Callable<HealthCheckResult> {

private final Logger log = LoggerFactory.getLogger(getClass());
	
	private String endPoint;
	private String strSellerCode;
	
	public SELLERSTHealthCheckImpl(String endPoint, GetApiConfigValues objGetConfig) {
		this.endPoint = endPoint;
		strSellerCode = objGetConfig.getSellerSTSellerCode();
	}
	...
	public HealthCheckResult call() throws Exception {
		...
		String healthCheckUrl = endPoint + "/ping";
		String getAPIUrl = endPoint + "/sellers/states?sellerCode=" + strSellerCode;
		HealthCheckResult result = new HealthCheckResult(Component.SELLERST.code());
