...
public class SFMobileHealthCheckImpl implements Callable<HealthCheckResult>{

	private final Logger log = LoggerFactory.getLogger(getClass());
	
	private String endPoint;
	
	public SFMobileHealthCheckImpl(String endPoint) {
	...
	public HealthCheckResult call() throws Exception {
		...
		HealthCheckResult result = new HealthCheckResult(Component.SFMOBILE.code());
		log.debug("Checking if SF Mobile server is up on endpoint: " + endPoint);
